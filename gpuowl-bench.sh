...
./gpuowl -prp 1398269 -iters 100000 -log 10000 -cpu $1 -results bench-1398269-$1-$COUNTER.txt
# Last known prime
./gpuowl -prp 82589933 -iters 100000 -log 10000 -cpu $1 -results bench-82589933-$1-$COUNTER.txt
# Largest SEL computed exponent
./gpuowl -prp 332412937 -iters 100000 -log 10000 -cpu $1 -results bench-332412937-$1-$COUNTER.txt
